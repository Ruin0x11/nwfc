return {
    set = {
        neighbors = {
            ...
            {left = "bridge", right = "t"}, {left = "bridge", right = "t 3"},
            ...
            {left = "river", right = "t 1"}, {left = "river", right = "tower"},
            ...
            {left = "road 1", right = "t"}, {left = "road 1", right = "t 3"},
            {left = "road", right = "tower"}, {left = "road", right = "wall"},
            ...
            {left = "t", right = "t 2"}, {left = "t 3", right = "tower"},
            {left = "t 3", right = "wall"}, {left = "t", right = "wallroad"},
        ...
        tiles = {
            ...
            {name = "ground", symmetry = "X"}, {name = "river", symmetry = "I"},
            {name = "riverturn", symmetry = "L"},
            {name = "road", symmetry = "I"},
            {name = "roadturn", symmetry = "L"}, {name = "t", symmetry = "T"},
            {name = "tower", symmetry = "L"}, {name = "wall", symmetry = "I"},
