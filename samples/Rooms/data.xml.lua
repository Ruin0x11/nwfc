return {
    set = {
        neighbors = {
            ...
            {left = "door", right = "side 2"}, {left = "door 1", right = "t"},
            {left = "door 1", right = "t 3"},
            {left = "door 1", right = "turn 1"},
            {left = "empty", right = "empty"},
            {left = "empty", right = "side 3"}, {left = "side", right = "side"},
            {left = "side 3", right = "side 1"},
            {left = "side 3", right = "t 1"}, {left = "side 3", right = "turn"},
            {left = "side 3", right = "wall"}, {left = "t", right = "t 2"},
            {left = "t", right = "turn 1"}, {left = "t 3", right = "wall"},
            {left = "turn", right = "turn 2"},
            {left = "turn 1", right = "wall"}, {left = "wall", right = "wall"},
            {left = "bend", right = "bend 1"},
            {left = "corner", right = "bend 2"},
            {left = "door", right = "bend 2"}, {left = "empty", right = "bend"},
