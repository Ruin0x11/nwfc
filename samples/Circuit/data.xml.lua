return {
    set = {
        neighbors = {
            ...
            {left = "t 1", right = "t 3"}, {left = "t 3", right = "t 1"},
            {left = "t 1", right = "t 2"}, {left = "t 2", right = "t 2"},
            {left = "t 2", right = "t"}, {left = "t 3", right = "track"},
            ...
            {left = "t 3", right = "turn"}, {left = "t 1", right = "turn 1"},
            {left = "t 2", right = "turn 1"}, {left = "t 2", right = "turn 2"},
            {left = "t 3", right = "viad 1"}, {left = "t 1", right = "viad"},
            {left = "t 2", right = "viad"}, {left = "t 2", right = "vias 1"},
            {left = "t 1", right = "vias 1"}, {left = "vias 1", right = "t 1"},
            {left = "vias 2", right = "t 1"}, {left = "wire 1", right = "t 1"},
            ...
            {left = "vias 2", right = "vias"}, {left = "wire", right = "wire"},
            {left = "wire 1", right = "wire 1"},
            {left = "bridge 1", right = "dskew"},
            {left = "connection 3", right = "dskew"},
            {left = "dskew", right = "dskew"}, {left = "skew", right = "dskew"},
            {left = "t", right = "dskew"}, {left = "t 2", right = "dskew"},
            ...
            {left = "skew", right = "dskew"}, {left = "skew", right = "skew 2"},
            {left = "skew 1", right = "skew"},
            {left = "skew 1", right = "skew 3"},
            {left = "substrate", right = "skew"},
            {left = "t 3", right = "skew"}, {left = "t", right = "skew 2"},
            {left = "t 2", right = "skew 2"}, {left = "t 1", right = "skew 2"},
            ...
            {left = "viad", right = "skew 2"}, {left = "vias", right = "skew"},
